...
- The contact-death check (the AABB kill rule in `Game.checkCollisions`) still applies at the post-dash position, so landing on an enemy kills the player.
