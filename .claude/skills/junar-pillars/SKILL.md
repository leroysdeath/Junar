...
## Six Pillars (README §3 / CLAUDE.md §3)
...
6. **Short prototype, tight scope.** Ten levels + one boss arena. Resist scope creep until the loop is solid.
...
- New input method (gamepad, mouse-aim, etc.) → Pillar 1 + Invariant 1. Auto-fire only.
